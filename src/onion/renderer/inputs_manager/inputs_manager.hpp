...
namespace Onion::Controls {
	...
	struct InputConfig {
		...
		InputConfig(bool enableControlledKeyRepeatWhenHold = false, double keyRepeatDelayWhenHold = 0.6f,
			double keyRepeatIntervalWhenHold = 0.4f, double doublePressDelay = 0.5f)
			: EnableControlledKeyRepeatWhenHold(enableControlledKeyRepeatWhenHold),
			KeyRepeatDelayWhenHold(keyRepeatDelayWhenHold),
			KeyRepeatIntervalWhenHold(keyRepeatIntervalWhenHold),
